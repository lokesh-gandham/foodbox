...
export class UserServiceService {
  ...
  public addRecipe(product: Product, image: Blob): Observable<any> {
  ...
  public getRecipeByCategory(category: string): Observable<any[]> {
    return this.http.get<any[]>(`${this.baseUrl}/get/products-by-category/${category}`);
  }

  public deleteRecipe(pid: number): Observable<any> {
  ...
  public updateRecipe(pid: number, product: Product): Observable<any> {
